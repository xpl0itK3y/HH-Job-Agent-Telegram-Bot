...
class AuditLogsPage:
    ...
    def render(self) -> None:
        st.markdown('<div class="admin-page-title">Audit Logs</div>', unsafe_allow_html=True)
        st.markdown(
            '<div class="admin-page-subtitle">Destructive and operator actions recorded in admin_audit_logs.</div>',
